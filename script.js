                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center">
                            <span class="display-1 d-block">🤷‍♂️</span>
                            <div class="mb-4 lead">
        ...
        html += `
          <div id="meal-details" class="mb-5">
            <div id="meal-header" class="d-flex justify-content-around flex-wrap">
              ...
              <div id="details" class="text-color">
                <h3>${data.meals[0].strMeal}</h3>
                <h6>Category : ${data.meals[0].strCategory}</h6>
                <h6>Area : ${data.meals[0].strArea}</h6>
              </div>
            </div>
            <div id="meal-instruction" class="mt-3 text-color">
              <h5 class="text-center">Instruction :</h5>
              <p class="text-color">${data.meals[0].strInstructions}</p>
            </div>
...
function addRemoveToFavList(id) {
    ...
    if (contain) {
        ...
        arr.push(id);
        alert("Meal added on your favourites list");
    }
